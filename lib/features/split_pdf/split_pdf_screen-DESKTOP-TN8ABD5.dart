...
class _SplitPdfScreenState extends ConsumerState<SplitPdfScreen> {
  ...
  Future<void> _split() async {
    ...
    try {
          ...
          MaterialPageRoute(
            builder: (context) => ResultScreen(
              ...
              pageCount: extractedStart != null && extractedEnd != null
                  ? PageRangeValidator.toPageIndices(extractedStart, extractedEnd).length
                  : null,
              onProcessAnother: () {
                Navigator.of(context).pop();
                _reset();
      ...
      if (mounted) {
        setState(() => _fatalError = 'Unable to split this PDF. Please try again.');
      }
    } finally {
              ...
              children: [
                ...
                if (_selectedPath == null) ...[
                  ...
                  FilledButton.icon(
                    ...
                    label: Text(
                      _mode == SplitMode.extractRange ? 'Extract Pages' : 'Split All Pages',
                    ),
                  ),
                ],
              ],
